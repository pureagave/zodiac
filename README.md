...
- Drive-to navigation: pick a destination (HOME = camp at Heiau & 2:15, MAN = Golden Spike, TEMPLE) from a prominent full-width `DRIVE TO` button bar above the footer; the ops footer then shows bearing + distance + a heading-relative arrow to it.
